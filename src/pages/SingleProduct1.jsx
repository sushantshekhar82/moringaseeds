...
const SingleProductone = () => {
    const [selectedImage, setSelectedImage] = useState('./brand1.webp');
     ...
     const [bgColor6,setBgColor6]=useState('white')
      ...
      const [product,setProduct]=useState("PKM Drumstick Seeds")
    ...
    <Box width={{base:'95%',md:'95%',lg:'95%'}} margin={'auto'} >
      ...
      {thumbnails.map((thumbnail, index) => (
       ...
       <GridItem  textAlign={'left'}>
        ...
        <Text  as={'h1'} fontSize={{base:'3xl',md:'4xl',lg:'5xl'}}  fontWeight={'bold'} >PKM Drumstick Seeds</Text>
